...
class KategoriController extends Controller
{
    ...
    {
        $kategori = m_kategoriModel::create($request->safe()->all());
        if (empty($kategori)) {
     ...
     */
    public function show(m_kategoriModel $kategori): JsonResponse
    {
        return response()->json([
            'success' => true,
            'kategori' => $kategori
     ...
     */
    public function update(KategoriRequest $request, m_kategoriModel $kategori): JsonResponse
    {
     ...
     */
    public function destroy(m_kategoriModel $kategori): JsonResponse
    {
        try {
            $kategori->delete();
            return response()->json([
