...
class t_stokController extends Controller
{
    ...
    {
        $stocks = t_stokModel::select(['stok_id', 'barang_id', 'user_id', 'stok_tanggal', 'stok_jumlah'])->with(['barang', 'user']);
    ...
    {
        $stok = t_stokModel::with('barang', 'user')->find($id);
